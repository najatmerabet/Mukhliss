...
class _SettingsScreenState extends ConsumerState<SettingsScreen>
  ...
  Future<void> _checkConnectivity() async {
    try {
      ...
      AppLogger.debug('hasinternet $hasInternet');
      if (mounted) {
        setState(() {
  ...
  Future<bool> _testSingleEndpoint(String url) async {
    try {
      ...
      debugPrint(
        'Endpoint $url returned: ${response.statusCode} - Success: $isSuccess',
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          // Modern SliverAppBar
          AppBarTypes.parametresAppBar(context),
          // Content
          SliverToBoxAdapter(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSectionHeader(
                      l10n?.securite ?? 'SÉCURITÉ & CONFIDENTIALITÉ',
  ...
  void _showLanguageDialog(BuildContext context) {
    final currentLanguage =
        ref.read(languageProvider.notifier).currentLanguageOption;

...
/// Alias pour le ThemeMode de Flutter
typedef FlutterThemeMode = flutter_material.ThemeMode;
...
class AppColors {
  ...
  static const Color darkPrimary = Color.fromARGB(
    ...
    13,
    14,
  ); // Version sombre de 0xFF765EFF
  static const Color darkSecondary = Color.fromARGB(
    255,
    0,
    0,
    0,
  ); // Version sombre de 0xFFC4BAFF
  static const Color darkSurface = Colors.black;
  static const Color darkBackground = Color(0xFF111827);
  static const Color darkTextPrimary = Color(0xFFF9FAFB);
  static const Color darkTextSecondary = Color(0xFFD1D5DB);
  static const Color darkWhite = Color.fromARGB(
    255,
    247,
    250,
    252,
  ); // Gris très clair pour dark
  static const Color darkGrey50 = Color.fromARGB(
    255,
    191,
    194,
    196,
  ); // Gris plus foncé pour dark

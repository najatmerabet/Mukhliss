...
class LanguageNotifier extends StateNotifier<Locale> {
  ...
  Future<void> _loadSavedLanguage() async {
    try {
      ...
      AppLogger.debug('Erreur lors du chargement de la langue: $e');
    }
  }
  ...
  Future<void> changeLanguage(Locale newLocale) async {
    try {
      ...
      AppLogger.debug('Langue changée vers: ${newLocale.languageCode}');
    } catch (e) {
      AppLogger.debug('Erreur lors du changement de langue: $e');
    }
  }

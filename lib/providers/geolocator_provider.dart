...
import 'package:mukhliss/services/geolocator_service.dart';
...
final positionStreamProvider = StreamProvider.autoDispose.family<Position, double>((ref, distanceThreshold) {
  final geolocationService = ref.read(geolocationServiceProvider);
  return geolocationService.trackPositionWithThreshold(distanceThreshold: distanceThreshold);
});

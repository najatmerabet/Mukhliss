...
import 'package:mukhliss/core/widgets/Appbar/custom_sliver_app_bar.dart';

class AppBarTypes {
  // AppBar pour les offres
  static CustomSliverAppBar offersAppBar(
  ...
  /// AppBar pour les paramètres
  static CustomSliverAppBar parametresAppBar(BuildContext context) {
    final l10n = AppLocalizations.of(context);
    return CustomSliverAppBar(
  ...
  static CustomSliverAppBar localisationAppBar(
    BuildContext context, {
    List<Widget>? actions,
  }) {
    final l10n = AppLocalizations.of(context);
  ...
  static CustomSliverAppBar profileAppBar(
    BuildContext context, {
    List<Widget>? actions,
  }) {
    final l10n = AppLocalizations.of(context);
